...
static void paw3395_task(void* pvParameters)
{
	...
	auto ret =
		g_sensor.init(SPI3_HOST, PIN_NUM_CS, PIN_NUM_MOTION, 600,
	...
	TimerHandle_t connection_state_timer =
		xTimerCreate("connection_state", pdMS_TO_TICKS(1000), pdTRUE, nullptr,
					 [](TimerHandle_t xTimer) { send_app_event(APP_EVENT_CONNECTION); });
